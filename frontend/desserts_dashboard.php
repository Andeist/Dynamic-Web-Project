...
<body>
  ...
  <div class="container">
    <div class="row">
      <div class="col-12">
       <div class="mt-4"> 
      <h1 class="text-center mb-5 bg-primary text-white p-3">Desserts List</h1>
        <div class="d-flex justify-content-start mb-3">
          <button class="btn btn-success" id="newDessert" data-bs-toggle="modal" data-bs-target="#newDessertModal">
            <i class="bi bi-plus-lg"></i> Add new dessert
          </button>
  ...
  <!--Dashboard-->
    ...
    <div class="modal fade" id="newDessertModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="exampleModalLabel">Add New Dessert</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div class="alert alert-primary" role="alert" id="addMessage" style="display:none;"></div>
                    <form method="POST" id="addDessertForm" enctype="multipart/form-data">
                        <div class="form-outline form-dark mb-4">
                            <label class="form-label" for="addDessertName">Dessert Name</label>
                            <input type="text" name="name" id="addDessertName" class="form-control" />
                            <small class="text-danger ml-5" id="addDessertNameError"></small>
                        </div>
                        <div class="form-outline form-dark mb-4">
    ...
    <!-- Edit Dessert Modal -->
    <div class="modal fade" id="editDessertModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="exampleModalLabel">Edit Dessert</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div class="alert alert-primary" role="alert" id="editMessage" style="display:none;"></div>
                    <form method="POST" id="editDessertForm" enctype="multipart/form-data">
                        <div class="form-outline form-dark mb-4">
                            <label class="form-label" for="editDessertName">Dessert Name</label>
                            <input type="text" name="name" id="editDessertName" class="form-control form-control" />
                            <small class="text-danger ml-5" id="editDessertNameError"></small>
                        </div>
                        <div class="form-outline form-dark mb-4">
    ...
    <script src="../backend/dessert_crud.js"></script>
